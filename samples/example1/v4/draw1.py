...
diagram.add_node(id="VBRREPOWIN01",label="VBRREPOWIN01",style=styles_dir+"/VBRMOUNTSERVER.txt",x_pos="160",y_pos="40",width="60",height="60",data={"ip": "192.168.42.2/24","role":"VBRMOUNTSERVER","other_roles":"VBRBACKUPREPOSITORY,VBRBACKUPREPOSITORY,VBRBACKUPREPOSITORYWINDOWS,VBRPOWERNFS"})

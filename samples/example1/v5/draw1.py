...
diagram.add_node(id="ESXI02",label="ESXI02",style=styles_dir+"/VMWAREESXI.txt",x_pos="560",y_pos="440",width="60",height="60",data={"ip": "192.168.42.12/24","role":"VMWAREESXI","other_roles":""})
...
diagram.add_node(id="VBRREPOWIN01",label="VBRREPOWIN01",style=styles_dir+"/VBRBACKUPREPOSITORYWINDOWS.txt",x_pos="160",y_pos="40",width="60",height="60",data={"ip": "192.168.42.2/24","role":"VBRBACKUPREPOSITORYWINDOWS","other_roles":"VBRBACKUPREPOSITORY,VBRMOUNTSERVER,VBRPOWERNFS"})
diagram.add_node(id="VC01",label="VC01",style=styles_dir+"/VMWAREVCENTER.txt",x_pos="730",y_pos="40",width="60",height="60",data={"ip": "192.168.42.10/24","role":"VMWAREVCENTER","other_roles":""})

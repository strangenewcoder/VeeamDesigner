...
diagram.add_node(id="ESXI01",label="ESXI01",style=styles_dir+"/VMWAREESXI.txt",x_pos="300",y_pos="300",width="60",height="60",data={"ip": "192.168.42.11/24","role":"VMWAREESXI","other_roles":""})
diagram.add_node(id="ESXI02",label="ESXI02",style=styles_dir+"/VMWAREESXI.txt",x_pos="400",y_pos="400",width="60",height="60",data={"ip": "192.168.42.12/24","role":"VMWAREESXI","other_roles":""})
...
diagram.add_node(id="VBRREPOWIN01",label="VBRREPOWIN01",style=styles_dir+"/VBRMOUNTSERVER.txt",x_pos="150",y_pos="80",width="60",height="60",data={"ip": "192.168.42.2/24","role":"VBRMOUNTSERVER","other_roles":"VBRBACKUPREPOSITORY,VBRBACKUPREPOSITORY,VBRBACKUPREPOSITORYWINDOWS,VBRPOWERNFS"})
diagram.add_node(id="VC01",label="VC01",style=styles_dir+"/VMWAREVCENTER.txt",x_pos="500",y_pos="500",width="60",height="60",data={"ip": "192.168.42.10/24","role":"VMWAREVCENTER","other_roles":""})
...
diagram.add_link("ESXI01","VC01",trgt_label="443")
diagram.add_link("ESXI02","VC01",trgt_label="443")
